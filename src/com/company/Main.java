...
public class Main {
	...
	public static double sin(int n, double x) {
		...
		return sin(1, (n-1)*x)*cos(1, (n-1)*x) + cos(1, (n-1)*x)*sin(1, (n-1)*x); //otherwise, create new instance with n-1
	}
	...
	public static double cos(int n, double x) {
		...
		return cos(1, (n-1)*x)*cos(1, (n-1)*x) + sin(1, (n-1)*x)*sin(1, (n-1)*x); //otherwise, create new instance with n-1
	}
